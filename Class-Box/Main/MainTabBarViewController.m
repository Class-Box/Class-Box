...
- (void)viewDidLoad {
    ...
    [ttVc setTitle:@"课表"];
    [self initTabBarItem:ttVc.tabBarItem Title:@"课表" SelectedImage:@"tabBar_essence_click_icon" UnselectedImage:@"tabBar_essence_icon"];
    ...
    [dVc setTitle:@"发现"];
    [self initTabBarItem:dVc.tabBarItem Title:@"发现" SelectedImage:@"tabBar_friendTrends_click_icon" UnselectedImage:@"tabBar_friendTrends_icon"];
    ...
    [mvc setTitle:@"我"];
    [self initTabBarItem:mvc.tabBarItem Title:@"我" SelectedImage:@"tabBar_new_click_icon" UnselectedImage:@"tabBar_new_icon"];
    ...
    [self initTabBarItem:msgvc.tabBarItem Title:@"消息" SelectedImage:@"tabBar_me_click_icon" UnselectedImage:@"tabBar_me_icon"];
    msgvc.title = @"消息";
